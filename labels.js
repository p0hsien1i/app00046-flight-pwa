...
window.LABELS = {
  ...
  detail: {
    ...
    mapBtn: "Live map",
    mapLoading: "Locating aircraft…",
    mapNotAirborne: "Aircraft isn't transmitting a position right now (on the ground or out of ADS-B coverage).",
    mapNoId: "Look up the flight first so we know the aircraft.",
    mapInfo: "{alt} ft · {gs} kt · updated {sec}s ago",
    loading: "Checking…",
